                ...
                <div class="modal-header">
                    <h1 class="modal-title fs-5" id="exampleModelLabel">Tambah Data</h1>
                            ...
                            <form action="proses_simpan_petugas.php" method="post">
                                ...
                                <div class="form-group">
                                        <label>Nama Petugas</label>
                                        <input type="text" required="nama_petugas" class="form-control">
                                    </div>
                                    <div class="form-group">
                                        <label>Username</label>
                                        <input type="text" required="username" class="form-control">
                                    </div>
                                    <div class="form-group">
                                        <label>Password</label>
                                        <input type="text" required="password" class="form-control">
                                    </div>
                                    <div class="form-group">
                                        <label>Akses Petugas</label>
                                        <select required="level" class="form-control">
