                ...
                <div class="modal-header">
                    <h1 class="modal-title fs-5" id="exampleModelLabel">Tambah Data</h1>
                            ...
                            <form action="proses_pembelian.php" method="post">
                                ...
                                <div class="form-group">
                                        <label>No</label>
                                        <input type="number" required="PelangganID" value="<?php echo date("dmHis")?>" class="form-control">
                                    </div>
                                    <div class="form-group">
                                        <label>Nama Pelanggan</label>
                                        <input type="text" required="NamaPelanggan" class="form-control">
                                    </div>
                                    <div class="form-group">
                                        <label>Alamat</label>
                                        <input type="text" required="Alamat" class="form-control">
                                    </div>
                                    <div class="form-group">
                                        <label>Nomor Telepon</label>
                                        <input type="number" required="NomorTelepon" class="form-control">
                                    </div>
                                </div>
                                <div class="modal-footer">
